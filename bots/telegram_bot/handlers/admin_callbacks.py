...
from database.plans import get_all_plans, get_plan, update_plan
...
async def admin_callback(
    ...
    if data.startswith("user_info:"):
        ...
        usage = get_usage(target_user_id)
    ...
    if data.startswith("toggle_ban:"):
        ...
        if ban_info.get("reason"):
            ...
            await query.edit_message_text("✅ کاربر از حالت بن خارج شد.")
        else:
    ...
    if data == "ban_user":
        ...
        await query.edit_message_text(
            "🚫 حالت مدیریت بن فعال شد.\n\n"
            "برای بن کردن یک کاربر، شناسه او را بفرست.\n"
            "مثال: 123456 یا unban 123456"
        )
