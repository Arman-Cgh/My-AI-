...
class PGCursor:
    ...
    def execute(self, sql, params=None):
        # Convert qmark placeholders (?) to %s for psycopg2
        if params is None:
...
def get_connection():
    ...
    # Ensure local database folder exists for sqlite
    ...
    if DATABASE_URL:
        try:
            ...
            # fallback to sqlite if psycopg2 not available or connection fails
            pass
